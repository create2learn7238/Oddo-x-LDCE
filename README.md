...
GlobeTrotter is a full-featured, responsive, multi-city travel planning platform powered by a **React + Vite** frontend, **Express.js API**, and a live **PostgreSQL (Neon DB)** relational database.

---

## 🌟 Key Features

- 🔐 **Authentication:** User signup & login with session persistence and demo access.
- 🗺️ **Itinerary Builder:** Add, edit, reorder stops, and schedule activities day-by-day.
...
### 2. Initialize PostgreSQL Database Schema & Seed Data
```bash
npm run db:init
```
